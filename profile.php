                    ...
                    <div class="account-container">
                        <div class="account-data row">
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                <div class="left-account-data">
                                    <div class="avatar-wrapper">
                                        <img src="images/user2.jpg" class="" alt="">
                                    </div>
                                    <div class="account-change-btn custom-btn blue-button">
                                        <a href="">
                                            Редактировать
                                        </a>
                                    </div>
                            ...
                            <div class="col-xl-9 col-lg-8  col-md-8 col-sm-6">
                                <div class="right-account-data row">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-5 col-sm-10 col-9">
                                        <div class="account-phone-wrapper">
                                            <div class="account-phone-ico">
                                                <img src="images/ico/phone-circle.svg" class="img-fluid" alt="">
                                            </div>
                                            <div>
                        ...
                        <div class="managed-post-wrapper">
                            <div class="managed-post-header">
                                <div class="post-header-title">Мои Объявления</div>
