...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="stylesheet/mydialog.css?<?= mt_rand(1, 1000000) ?>">
        ...
        <div class="account-wrapper">
            <div class="account-main container">
                <div class="account-sidebar">
                    <div class="account-sidebar-background"></div>
                ...
                <div class="account-body">
                    <div class="account-container">
                                ...
                                <div class="row">
                                    <div class="form-input col-5">
                                        <div class="drop-down-wrapper">
                                            ...
                                            <div class="animated drop-down-card" style="display: none;">
                                                <ul>
                                                    
                                                    <li class="drop-down-item">
                                                        
                                                        <span class="drop-down-cat-name">Все объявления</span>
                                                    </li>
                                                    <li class="drop-down-item">
                                                        
                                                        <span class="drop-down-cat-name">- MacBock pro 234 latdfdfdf d 2017</span>
                                                    ...
                                                    <li class="active-drop-down-item drop-down-item">
                                                        ...
                                                        <span class="drop-down-cat-name">- Бензокоса PARTNER DX 62(Orig...</span>
                                                        <span class="hover-arrow">
                                                            <img src="images/ico/arrow-right.svg" class="img-fluid ico-xs" alt="">
                                                        </span>
                                                    </li>
                                                    <li class="  drop-down-item">
                                                        <span class="drop-down-cat-name">- Ауди А4. Декабрь 2000г. 1,6.Бен..</span>
                                                        <span class="hover-arrow">
                                                            <img src="images/ico/arrow-right.svg" class="img-fluid ico-xs" alt="">
                                                        </span>
                                                    </li>
                        ...
                        <div class="dialogs-group">
                            <div class="dialog incoming-dialog unread">
                                <a href="">
                                    <div class="dialog-body ">
                                        <div class="dialog-body-left ">
                                            <div class="mailer-preview rounded-circle">
                                                <img src="images/user2.jpg" class="" alt="">
                                            </div>
                                        ...
                                        <div class="dialog-body-main">
                                            <div class="dialog-body-center">
                                                ...
                                                <div class="dialog-mailer-name">
                                                    <span>Дмитрий</span>
                                                </div>
                                                <div class="message-subject">
                                                    Лавка красивая желзная...
                                                </div>
                            ...
                            <div class="dialog outgoing-dialog unread">
                                <a href="">
                                    <div class="dialog-body ">
                                        <div class="dialog-body-left ">
                                            <div class="mailer-preview rounded-circle">
                                                <img src="images/user4.jpg" class="" alt="">
                                            </div>
                                        </div>
                                        <div class="dialog-body-main">
                                            <div class="dialog-body-center">
                                            ...
                                            <div class="dialog-body-right">
                                                ...
                                                <div class="dialog-message">
                                                    <div class="outgoing-user-ico rounded-circle">
                            ...
                            <div class="dialog outgoing-dialog read">
                                <a href="">
                                    <div class="dialog-body ">
                                        <div class="dialog-body-left ">
                                            <div class="mailer-preview rounded-circle">
                                                <img src="images/user1.jpg" class="" alt="">
                                            </div>
                                        </div>
                                        <div class="dialog-body-main">
                            ...
                            <div class="dialog incoming-dialog read">
                                <a href="">
                                    <div class="dialog-body ">
                                        <div class="dialog-body-left ">
                                            <div class="mailer-preview rounded-circle">
                                                <img src="images/user3.jpg" class="" alt="">
                                            </div>
                                        </div>
                                        <div class="dialog-body-main">
                                            ...
                                            <div class="dialog-body-right">
                                                ...
                                                <div class="dialog-message ">
                                                    Отправил посылку наложеным платежем
                                                </div>
